...
#
RUN apk --update add build-base libpng-dev automake autoconf gettext libtool git python
...
#
RUN apk del git gettext libtool autoconf automake libpng-dev build-base && \
    rm -fR /var/cache/apk/*;
WORKDIR /app/web/
